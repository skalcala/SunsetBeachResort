...
$rooms = [
  ...
  6 => ['name'=>'Justine Villa','price'=>7999,'image'=>'images/rooms/xuvilla.png','capacity'=>5],
  7 => ['name'=>'Xu Villa','price'=>8999,'image'=>'images/rooms/110.png','capacity'=>5],
  8 => ['name'=>'Lafuente Villa','price'=>9999,'image'=>'images/rooms/laf.png','capacity'=>5],
];
...
async function doPayment(provider){
  ...
  createData.append('adults', adults);
  createData.append('children', children);
